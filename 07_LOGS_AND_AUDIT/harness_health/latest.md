...
- generated_at_utc: 2026-06-21T18:48:59Z
- overall_status: red
...
|---|---|---|
| input_freshness_governance_intelligence | fail | input 'governance_intelligence' is 537.98h old (fail threshold: 72h) |
| input_freshness_token_governance | fail | input 'token_governance' is 454.19h old (fail threshold: 72h) |
| unified_guard_ok | fail | ok=False |
| token_governance_green | fail | status=red |
| pre_session_fresh | fail | age_min=None |
| unified_guard_fresh | fail | age_min=1662.11 |
...
| agent_log_fresh_and_populated | pass | age_min=3.7 lines=169 |
