...
- generated_at_utc: 2026-06-16T16:17:28Z
- overall_status: red
- readiness_score: 4/100

## Check Results

| Check | Status | Message |
|---|---|---|
| input_freshness_governance_intelligence | fail | input 'governance_intelligence' is 415.46h old (fail threshold: 72h) |
| input_freshness_token_governance | pass | input 'token_governance' is 0.0h old (ok) |
| unified_guard_ok | fail | ok=False |
| token_governance_green | fail | status=red |
| pre_session_fresh | pass | age_min=7.9 |
| unified_guard_fresh | pass | age_min=0.26 |
...
| agent_log_fresh_and_populated | pass | age_min=8.5 lines=79 |
