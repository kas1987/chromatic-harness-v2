...
- generated_at_utc: 2026-06-19T16:54:11Z
- overall_status: red
- readiness_score: 16/100

## Check Results

| Check | Status | Message |
|---|---|---|
| input_freshness_governance_intelligence | fail | input 'governance_intelligence' is 488.07h old (fail threshold: 72h) |
| input_freshness_token_governance | pass | input 'token_governance' is 0.01h old (ok) |
| unified_guard_ok | pass | ok=True |
| token_governance_green | fail | status=red |
| pre_session_fresh | pass | age_min=236.49 |
| unified_guard_fresh | pass | age_min=19.12 |
| handoff_present | pass | handoff_present=True |
...
| agent_log_fresh_and_populated | warn | age_min=3003.56 lines=49 |
