---
name: cloud-vs-local-routing-strategy
type: anti-pattern
confidence: 0.90
source_learnings: [2026-04-26-cloud-vs-local-routing-strategy]
description: Learning: Cloud vs Local (Ollama) Routing Strategy
