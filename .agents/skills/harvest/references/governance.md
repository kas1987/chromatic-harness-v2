...
- **Cross-rig:** done by the `/harvest` skill itself — SHA256 content hash on normalized body, computed during the manual promotion step (no `ao harvest` subcommand exists)
