...
**Canonical matrix:** `chromatic-wiki/03_GOVERNANCE/multi-router-matrix.yaml`  
(federate via `bash chromatic-wiki/scripts/federate-governance.sh`; this file is the canonical source).
