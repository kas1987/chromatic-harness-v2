...
> Auto-generated by `scripts/rudalo_migration_audit.py` at `20260601T130133Z`
...
- **[WARN]** `10_RUNTIME`: Directory exists but contains no roach-pi state
- **[WARN]** `02_RUNTIME/10_RUNTIME`: Directory exists but contains no roach-pi state
...
- [x] Stub mode acceptable (submodule not required for harness to function)

## Recommendations

- Consider removing legacy directory (no roach-pi state): 10_RUNTIME
- Consider removing legacy directory (no roach-pi state): 02_RUNTIME/10_RUNTIME
