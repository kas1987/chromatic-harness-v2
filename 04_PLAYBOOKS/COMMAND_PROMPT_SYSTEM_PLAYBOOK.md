...
## 7. Related (cross-references, not redefinitions)

- Operator-mode execution detail is owned by [GO_MODE_PLAYBOOK.md](GO_MODE_PLAYBOOK.md); this playbook governs *mode switching*, not GO-mode internals.
- Umbrella PDR: [../08_PDRS/PDR_COMMAND_PROMPT_SYSTEM.md](../08_PDRS/PDR_COMMAND_PROMPT_SYSTEM.md).
- CMP remains final authority (see this doc §4 Safety Rule).
