...
| [PRE_SESSION_INVENTORY.md](PRE_SESSION_INVENTORY.md) | **Tools/MCP/CRG baseline** — what agents are exposed to (regeneratable) |
...
Full inventory: [docs/PRE_SESSION_AND_TOOLS.md](../docs/PRE_SESSION_AND_TOOLS.md)
