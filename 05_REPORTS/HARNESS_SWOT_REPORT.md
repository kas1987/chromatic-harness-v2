...
Generated: 2026-06-21T18:51:32Z  
...
- Remote branches total: **6**
- Non-main remote branches (merge/prune candidates): **5**
...
- Files with secret-pattern hits: **20**
  ...
  - `05_REPORTS\HARNESS_SWOT_REPORT.md`
    - line 164: - line 17: private-key: ${{ secrets.APP_PRIVATE_KEY }}  # pragma: allowlist secr
    - line 166: - line 36: private-key: ${{ secrets.APP_PRIVATE_KEY }}  # pragma: allowlist secr
    - line 168: - line 25: private-key: ${{ secrets.APP_PRIVATE_KEY }}  # pragma: allowlist secr
...
| Weaknesses | 140 untested scripts · 0 stale branches · 15 empty dirs |
| Opportunities | 6 auto-heal targets · 40.9% → 100% coverage potential |
| Threats | 0 large files · 20 secret-pattern files · 0 syntax errors |

_Report generated by `scripts/harness_swot.py` at 2026-06-21T18:51:32Z_