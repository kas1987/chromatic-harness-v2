# PDR - SWOT Opportunitie Remediation #6

**Status:** draft
**Track:** swot-opportunities-06
**Date:** 2026-06-16
...
SWOT finding requiring dedicated execution: "Add explicit required-check policy mapping in docs so advisory vs blocking gates are intentional and transparent.".
Source: 08_PDRS\SWOT_CI_CD_2026-06-16.md (opportunities item 6).
