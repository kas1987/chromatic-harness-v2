# PDR - SWOT Opportunitie Remediation #7

**Status:** draft
**Track:** swot-opportunities-07
**Date:** 2026-06-16
...
SWOT finding requiring dedicated execution: "Gradually burn down formatting debt and then promote `ruff format --check .` to a full-repo gate.".
Source: 08_PDRS\SWOT_CI_CD_2026-06-16.md (opportunities item 7).
