# PDR - SWOT Weaknesse Remediation #1

**Status:** draft
**Track:** swot-weaknesses-01
**Date:** 2026-06-16
...
SWOT finding requiring dedicated execution: "Lint scope was previously partial (`src/` and `tests/`), allowing script and runtime folders to bypass Ruff checks.".
Source: 08_PDRS\SWOT_CI_CD_2026-06-16.md (weaknesses item 1).
