# PDR - SWOT Weaknesse Remediation #5

**Status:** draft
**Track:** swot-weaknesses-05
**Date:** 2026-06-16
...
SWOT finding requiring dedicated execution: "Legacy formatting debt (many files not Ruff-formatted) prevents full-repo formatting gate activation today.".
Source: 08_PDRS\SWOT_CI_CD_2026-06-16.md (weaknesses item 5).
